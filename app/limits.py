...
# 1000 запросов/сутки на всех. Ограничение с одного ключа не даёт браузеру или
# скрипту в одиночку выесть минутную токен-квоту команды.
#
# Минутный порог подняли с 10 до 20 после прогона по живому серверу: проверка
# готовности отправляет десять сценариев подряд и упиралась в лимит уже на
# черновике. На защите так же будет вести себя жюри — несколько вопросов
# подряд без пауз на чтение. Настоящий предохранитель квоты всё равно ниже:
# суточный лимит на весь сервис.
MAX_PER_MINUTE = 20
MAX_PER_HOUR = 60
